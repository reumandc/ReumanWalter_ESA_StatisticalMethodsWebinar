...
\begin{frame}
\frametitle{The data: environmental}
\begin{itemize}
...
\begin{frame}
\frametitle{The data: populations}
\begin{itemize}
...
\item If we did not know the setup and wanted to infer causes of synchrony, could we do it?
\end{itemize}
\end{frame}
